 ...
 * It is responsible for automatically managing turn progression and detecting game-over conditions.
 *
 ...
 */
export function useGameLogic(params: {
  emitter: Emitter<GameEventsHandlers>;
  gameConfig: LocalGameConfig | OnlineGameConfig;
  game: IGameState;
